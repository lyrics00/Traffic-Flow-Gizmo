    ...
    def create_lanes(self): 
        ...
        for i in range(self.num_lanes):
            if self.orientation == 'up':
                ...
                if self.lane_directions[i] == 'straight-right' or self.lane_directions[i] == 'right' or self.lane_directions[i] == 'left' or self.lane_directions[i] == 'straight':
                    lane = Lane(i, self.road_x_position, (i * self.lane_width) + self.road_y_position, self.lane_width, self.lane_height, self.orientation, self.lane_directions[i])
                    lanes.add(lane)
                else:
                    lane = Lane(i, self.road_x_position, (i * self.lane_width) + self.road_y_position, self.lane_width, self.lane_height, self.orientation, turn_direction="straight")
